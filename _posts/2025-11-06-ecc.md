...
Formally, we will restrict ourselves to (block?) codes of the form:
\begin{align}
...
\begin{align}
\dist{\a,\b}\bydef \left|\\{i\in[n]\ \vert\ a_i \ne v_i \\}\right|
\end{align}
...
[^bw]: e.g., [Berlekamp–Welch](https://en.wikipedia.org/wiki/Berlekamp%E2%80%93Welch_algorithm), or [Sudan-Guruswami](https://en.wikipedia.org/wiki/Berlekamp%E2%80%93Welch_algorithm) for list-decoding beyond the singleton bound
