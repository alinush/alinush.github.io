...
> Correlated agreement for Reed–Solomon codes is one of the main technical tools in the analysis of prior IOPPs such as FRI and STIR, and is also at the heart of the security proof of WHIR. -- WHIR paper[^ACFY24e]
...
IIRC, for Johnson bound, $\delta\in\left(0,1-\sqrt{\rho}\right)$.
Since the rate $\rho\in(0,1)$, this means $\delta$ is "larger."
Therefore, there's less restriction on $|S|$ to be large.
